    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Row(
          ...
          children: [
            //! Drawer on the left side, allows navigation to different pages.
            MyDrawer(
              onPageSelected: (Widget newPage, String pageName) =>
                  _updateContent(
                      newPage, pageName), // Pass page name for storage
            ),

            //! Main content area where the selected page is displayed.
            Expanded(
              flex: 2, // Flex to give more space to the content area
